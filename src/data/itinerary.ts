...
export const trip: Trip = {
  ...
  days: [
    ...
    },
    {
      dayNumber: 2,
      date: "2026-08-01",
      title: "Black Hills → Devils Tower → Denver",
      route: "Lead → Devils Tower → Cheyenne → Denver",
      driveHours: 7.5,
      highlight: "Detour to Devils Tower, then the long haul south to Denver",
      lodging: {
      ...
      stops: [
        {
          ...
          type: "city",
          time: "7:00 AM",
          notes: "Early start for the Devils Tower detour — grab breakfast to go",
        },
        {
          id: "d2-devils-tower",
          ...
          type: "park",
          time: "8:15 – 9:45 AM",
          notes: "~1 hr 15 min west of Lead. America's first national monument — walk the 1.3-mi Tower Trail loop around the base. Covered by your America the Beautiful pass (else $25/vehicle).",
          links: {
            maps: "https://maps.google.com/?q=Devils+Tower+National+Monument",
            info: "https://www.nps.gov/deto/",
          },
        },
        {
          id: "d2-cheyenne",
          ...
          type: "food",
          time: "2:00 – 2:45 PM",
          notes: "~4 hr south from Devils Tower via WY-59. Fuel up and eat here.",
          links: {
